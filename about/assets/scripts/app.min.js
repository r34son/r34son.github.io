...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(document).ready(function () {
		var links = (0, _jquery2.default)('.jslvl__option');
		var picker = (0, _jquery2.default)('.jslvl__picker');
		var values = [13, 160, 385, 777];
	
		var slide = function slide(value) {
			return (0, _jquery2.default)(".jslvl__picker").css("left", value - 13);
		};
	
		slide(values[2]);
	
		links.click(function () {
			slide(values[(0, _jquery2.default)(this).index()]);
		});
		...
		picker.draggable({
			...
			stop: function stop(e, ui) {
				return slide(getClosest(parseInt(picker.css("left").replace("px", ''))));
			}
		});
	
		var getClosest = function getClosest(value) {
			var closest = null;
			_jquery2.default.each(values, function (_key, _value) {
